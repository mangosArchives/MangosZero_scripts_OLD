...
If you upgrade to *mangos-zero* version **0.18.1** or newer, you should first
backup any changes you made to the script library, and remove your old clone
of this repository from the mangos-zero source tree.
